        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token-id', url: 'https://github.com/Nilesh-Dhakane/Medical-Chatbot-Rag.git']])
                }
            }
        }
